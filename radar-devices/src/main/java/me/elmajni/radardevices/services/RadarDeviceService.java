package me.elmajni.radardevices.services;

import lombok.extern.slf4j.Slf4j;
import me.elmajni.radardevices.model.OverSpeedDetection;
import me.elmajni.radardevices.model.Radar;
...
public class RadarDeviceService {
    ...
    public void loadRadars(){
        ResponseEntity<Radar[]> exchange = restTemplate.exchange("http://localhost:8883/query/radars/all", HttpMethod.GET, null, Radar[].class);
    ...
    public void submitOverSpeedDetection(){
        ...
        if(!radar.getRadarStatus().equals("OFF")){
            ...
            this.restTemplate.exchange(
                    "http://localhost:9999/RADAR-COMMAND-SERVICE/commands/radar/overSpeed",
                    HttpMethod.POST,
    ...
    public void changerRadarStatus(){
        ...
        Radar radar=radarList.get(index);
            ...
            this.restTemplate.exchange(
                    "http://localhost:9090/commands/radar/changeStatus",
                    HttpMethod.POST,
